...
<img src="/images/PDGLinkUnity2/HeightFiedOutMessage.png" width="100%" height="100%" style="zoom:100%">
...
<img src="/images/PDGLinkUnity2/EngineDocData.png" width="100%" height="100%" style="zoom:150%">
...
<img src="/images/PDGLinkUnity2/SetLayerNode.png" width="100%" height="100%" style="zoom:150%">
再通过下面两个节点来调节Mask区域，和把这个mask转变成一个新的Layer(Volume)。

这样一套操作下来，加上之前生成的Layer,其实已经有一大堆了。
<img src="/images/PDGLinkUnity2/LayerGreating.png" width="100%" height="100%" style="zoom:150%">
...
<img src="/images/PDGLinkUnity2/TerrainAtt.png" width="100%" height="100%" style="zoom:150%">
这几个属性也对应了这几个节点。
<img src="/images/PDGLinkUnity2/AttCreatNodes.png" width="100%" height="100%" style="zoom:150%">
...
<img src="/images/PDGLinkUnity2/UnitySetting.png" width="100%" height="100%" style="zoom:150%">
